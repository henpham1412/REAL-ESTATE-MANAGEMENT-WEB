                        ...
                        <ul class="nav ace-nav">
                            ...
                            <li class="purple dropdown-modal">
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    ...
                                    <span class="badge badge-important" id="notification-badge"
                                ...
                                <ul
                                    ...
                                    <%-- <a href="javascript:void(0);" onclick="markAllAsReadNow()" class="pull-right"
                                        style="font-weight: normal; font-size: 11px;">Đọc tất cả</a>--%>
                                        <li class="dropdown-footer">
                                            <a href="javascript:void(0);" onclick="markAllAsReadNow()"
                                        ...
                                        <%-- <i class="ace-icon fa fa-caret-down"></i>--%>
                                            <%-- </a>--%>
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <a
                                                            href="${ctx}/admin/profile-<%=SecurityUtils.getPrincipal().getUsername()%>">
