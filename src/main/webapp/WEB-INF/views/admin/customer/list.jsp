<%-- Created by IntelliJ IDEA. User: HP Date: 30/11/2025 Time: 16:04 To change this template use File | Settings | File
    Templates. --%>
            ...
            <body>
                                                        ...
                                                        <%-- </h1>--%>
                                                            <%-- </div><!-- /.page-header -->--%>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <security:authorize
                                                                                                    ...
                                                                                                    <button
                                                                                                        ...
                                                                                                        <i
                                                                                                            class="ace-icon glyphicon glyphicon-list"></i>
                                                                                                    </button>
                                                                                                </security:authorize>
                                                                                                <a class="btn btn-xs btn-info"
                                                                                                    title="Sửa khách hàng"
                                                                                                    href="${ctx}/admin/customer-edit-${item.id}">
                                                                                                    <i
                                                                ...
                                                                <c:if test="${customerPage.totalPages > 0}">
                                                                    <%-- <ul class="pagination">--%>
                                                                        <%-- &lt;%&ndash; Nút Lùi (Previous)
                                                                            &ndash;%&gt;--%>
                                                                            <%-- <c:choose>--%>
                                                                                <%-- <c:when
                                                                                    test="${customerPage.first}">--%>
                                                                                    <%-- <li
                                                                                        ...
                                                                                        <%-- </c:when>--%>
                                                                                            <%-- <c:otherwise>--%>
                                                                                                <%-- <c:url
                                                                                                    var="prevPageUrl"
                                                                                                    value="/admin/customer-list">--%>
                                                                                                    <%-- <c:param
                                                                                                        name="page"
                                                                                                        value="${customerPage.number - 1}" />--%>
                                                                                                    <%-- <c:param
                                                                                                        name="size"
                                                                                                        value="${customerPage.size}" />--%>
                                                                                                    <%-- &lt;%&ndash;
                                                                                                        Thêm TẤT CẢ
                                                                                                        filter param vào
                                                                                                        đây
                                                                                                        ...
                                                                                                        <%-- <c:param
                                                                                                            name="managerName"
                                                                                                            value="${customerSearch.phoneNumber}" />--%>
                                                                                                        <%-- <c:param
                                                                                                            name="managerPhone"
                                                                                                            value="${customerSearch.email}" />--%>
                                                                                                        <%-- <c:param
                                                                                                            name="staffId"
                                                                                                            value="${customerSearch.staffId}" />--%>
                                                                                                        <%-- &lt;%&ndash;
                                                                                                            SỬA LẠI
                                                                                                            TYPECODE:
                                                                                                            Dùng vòng
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <%--
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                <%--
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    <%--
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        <form
                                                                                                                                                                                                                                            action="${ctx}/admin/customer-list"
                                                                                                                                                                                                                                            id="formSubmit"
                                                                                                                                                                                                                                            method="GET">
                                                                                                                                                                                                                                            <%-- Chuyển
                                                                                                                                                                                                                                                sang
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        <ul
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            <%-- Nút
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                --%>
                                                                                                                                                                                                                                                <li
                                                                                                                                                                                                                                                    class="page-item ${customerPage.first ? 'disabled' : ''}">
                                                                                                                                                                                                                                                    <a class="page-link"
                                                                                                                                                                                                                                                        href="javascript:void(0)"
                                                                                                                                                                                                                                                        onclick="gotoPage(${customerPage.number - 1})">Previous</a>
                                                                                                                                                                                                                                                </li>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <%-- Các
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    <c:forEach
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        <li
                                                                                                                                                                                                                                                            class="page-item ${i == customerPage.number ? 'active' : ''}">
                                                                                                                                                                                                                                                            <a class="page-link"
                                                                                                                                                                                                                                                                href="javascript:void(0)"
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    <%-- Nút
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        --%>
                                                                                                                                                                                                                                                        <li
                                                                                                                                                                                                                                                            class="page-item ${customerPage.last ? 'disabled' : ''}">
                                                                                                                                                                                                                                                            <a class="page-link"
                                                                                                                                                                                                                                                                href="javascript:void(0)"
                                                                                                                                                                                                                                                                onclick="gotoPage(${customerPage.number + 1})">Next</a>
                                                                                                                                                                                                                                                        </li>
                                                                                                                                                                                                                                        </ul>
                                                                </c:if>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table style="margin: 3em 0 0;" class="table table-striped table-bordered table-hover"
                                    id="stafflist">
                                    <thead>
                                        <tr>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" id="btnassignmentCustomer">Giao khách
                                    hàng</button>
                ...
                <script>
                    ...
                    function loadStaff(customerId) {
                        $.ajax({
                            url: window.APP_CONFIG.contextPath + "/api/customer/" + customerId + '/staffs',
                            type: "GET",
                            dataType: "JSON",
                    ...
                    function deleteCustomers(data) {
                        $.ajax({
                            ...
                            success: function (respond) {
                                console.log("success");
                                window.location.href = window.APP_CONFIG.contextPath + "/admin/customer-list?message=success";
                            },
                            error: function (respond) {
                                console.log("failed");
                                console.log(respond);
                                window.location.href = window.APP_CONFIG.contextPath + "/admin/customer-list?message=error";
                            }
                        });
                    }
                    ...
                    function assign(data) {
                        $.ajax({
                            url: window.APP_CONFIG.contextPath + "/api/customer/" + 'assignment',
                            type: "POST",
                            data: JSON.stringify(data),
                            contentType: "application/json",
                            dataType: "JSON",
