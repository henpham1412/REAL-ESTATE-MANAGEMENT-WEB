...
<%--	<script src="assets/js/bootstrap.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/bootstrap.min.js'/>"></script>
...
<%--	<script src="assets/js/ace.min.js"></script>--%>
    ...
    <%--	<script src="assets/js/jquery-ui.custom.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery-ui.custom.min.js'/>"></script>
    <%--	<script src="assets/js/jquery.ui.touch-punch.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery.ui.touch-punch.min.js'/>"></script>
    <%--	<script src="assets/js/jquery.easypiechart.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery.easypiechart.min.js'/>"></script>
    <%--	<script src="assets/js/jquery.sparkline.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery.sparkline.min.js'/>"></script>
    <%--	<script src="assets/js/jquery.flot.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery.flot.min.js'/>"></script>
    <%--	<script src="assets/js/jquery.flot.pie.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery.flot.pie.min.js'/>"></script>
    <%--	<script src="assets/js/jquery.flot.resize.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery.flot.resize.min.js'/>"></script>
    <%--	<script src="assets/js/ace-elements.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/ace-elements.min.js'/>"></script>
    <%--	<script src="assets/js/ace.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/ace.min.js'/>"></script>

    <!-- page specific plugin scripts -->
    <%--	<script src="assets/js/jquery-ui.min.js"></script>--%>
    <script type="text/javascript" src="<c:url value='/admin/assets/js/jquery-ui.min.js'/>"></script>
